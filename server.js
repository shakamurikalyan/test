module.exports = {
    init: function () {
        ...
        var ws = new WebSocket('ws://100.93.188.54:9090', {
            autoconnect: false,
            reconnect: false
        })
        ...
        ws.on('open', async function () {
            ...
            // await ws.login({
            //     gatewayId: 'Keus-6d5fba72-b78a-4442-aeeb-e3f5562a26da'
            // });
            // await ws.login({gatewayId: 'Keus-926e98c1-26c5-46a4-b53b-5589e379dc8c'});
